...
public class backup extends Activity implements OnClickListener {
	...
	public String Percent(String str) {
		...
		if (str.isEmpty()) {
			...
			double stringConvertDouble = Double.valueOf(str);
			stringConvertDouble /= 100;
			str = Double.toString(stringConvertDouble);
		} else {
			int indexOfOperator = 0;
			...
			if (subString.contains("E")) {
				double expArithmetic = Double.parseDouble(subString);
				expArithmetic /= 100;
				subString = Double.toString(expArithmetic);
			} else {
				double stringConvertDouble = Double.valueOf(subString);
				stringConvertDouble /= 100;
				subString = Double.toString(stringConvertDouble);
			}
			str += subString;
		}
		Display(str);
